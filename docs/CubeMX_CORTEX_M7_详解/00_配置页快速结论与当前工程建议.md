...
从当前工程生成代码看，[main.c](../../zuolan_signal_STM32_H7/Core/Src/main.c) 里已经有一个 `MPU_Config()`：
...
- [main.c](../../zuolan_signal_STM32_H7/Core/Src/main.c)
  - `MPU_Config()`
  - 后续如果启用 Cache，通常也会在这里看到 `SCB_EnableICache()` / `SCB_EnableDCache()`
- [zuolan_signal_STM32.ioc](../../zuolan_signal_STM32_H7/zuolan_signal_STM32.ioc)
  - CubeMX 配置源文件
- [03_阶段三_内存_Cache_DMA_MPU.md](../STM32H743_信号处理学习路线/03_阶段三_内存_Cache_DMA_MPU.md)
  - 这一阶段的系统学习路线
